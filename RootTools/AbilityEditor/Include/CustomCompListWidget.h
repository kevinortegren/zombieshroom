...
class CustomCompListWidget : public QListWidget
	...
	public:
		...
		void ViewSelectedData(QListWidgetItem* p_item, QtVariantPropertyManager* p_propMan, QtTreePropertyBrowser* p_propBrows);
		void SaveSelectedData(QListWidgetItem* p_item, QtVariantPropertyManager* p_propMan, QtTreePropertyBrowser* p_propBrows);
		void LoadData();
		void Clear();
	protected:
