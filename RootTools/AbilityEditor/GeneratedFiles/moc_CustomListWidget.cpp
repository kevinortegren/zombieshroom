...
#include "../Include/CustomListWidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CustomListWidget_t, stringdata) + ofs \
...
const QMetaObject CustomListWidget::staticMetaObject = {
    { &QListWidget::staticMetaObject, qt_meta_stringdata_CustomListWidget.data,
      qt_meta_data_CustomListWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CustomListWidget.stringdata))
        return static_cast<void*>(const_cast< CustomListWidget*>(this));
