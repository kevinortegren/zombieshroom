...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_CustomTreeWidget_t, stringdata) + ofs \
...
const QMetaObject CustomTreeWidget::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_CustomTreeWidget.data,
      qt_meta_data_CustomTreeWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CustomTreeWidget.stringdata))
        return static_cast<void*>(const_cast< CustomTreeWidget*>(this));
