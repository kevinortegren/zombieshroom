...
#include <adskDataHandle.h>			// for return type of element()
#include <adskDataIndex.h>			// for IndexCount and Index
#include <adskDebugCount.h>			// for Debug Count macro
#include <adskDataStreamIterator.h>	// for iterator
