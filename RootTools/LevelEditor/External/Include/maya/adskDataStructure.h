...
#include <adskRefCounted.h>				// for base class adsk::RefCounted
#include <adskCheckpointed.h>			// for base class adsk::Checkpoint
#include <adskDataMember.h>				// for Member::eDataType
#include <adskDataStructureIterator.h>	// for begin()/end()
#include <adskDebugCount.h>				// for DeclareObjectCounter()
