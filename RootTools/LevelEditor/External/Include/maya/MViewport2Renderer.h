...
enum DrawAPI
{
	...
	kAllDevices = kOpenGL | kDirectX11	//!< All : OpenGL and Direct X 11
};
...
public:
	...
	enum MObjectTypeExclusions
	{
		...
		kExcludeLocators			= 1<<(10),	//!< Exclude locators
		kExcludeDimensions			= 1<<(11),	//!< Exclude all measurement objects
		kExcludeSelectHandles		= 1<<(12),	//!< Exclude selection handles
		kExcludePivots				= 1<<(13),	//!< Exclude pivots
		kExcludeTextures			= 1<<(14),	//!< Exclude texure placement objects
		kExcludeGrid				= 1<<(15),	//!< Exclude grid drawing
		kExcludeCVs					= 1<<(16),	//!< Exclude NURBS control vertices
		kExcludeHulls				= 1<<(17),	//!< Exclude NURBS hulls
		kExcludeStrokes				= 1<<(18),	//!< Exclude PaintFX strokes
		kExcludeSubdivSurfaces		= 1<<(19),	//!< Exclude subdivision surfaces
		kExcludeFluids				= 1<<(20),	//!< Exclude fluid objects
		kExcludeFollicles			= 1<<(21),	//!< Exclude hair follicles
		kExcludeHairSystems			= 1<<(22),	//!< Exclude hair system
		kExcludeImagePlane			= 1<<(23),	//!< Exclude image planes
		kExcludeNCloths				= 1<<(24),	//!< Exclude N-cloth objects
		kExcludeNRigids				= 1<<(25),	//!< Exclude rigid-body objects
		kExcludeDynamicConstraints	= 1<<(26),	//!< Exclude rigid-body constraints
		kExcludeManipulators		= 1<<(27),	//!< Exclude manipulators
		kExcludeNParticles			= 1<<(28),	//!< Exclude N-particle objects
		kExcludeMotionTrails        = 1<<(29),	//!< Exclude motion trails
    ...
    enum MDisplayMode {
		...
		kShaded = 1<<(1),			//!< Display shaded textured
		kDefaultMaterial = 1<<(2),	//!< Use default material. Only applicable if shaded mode enabled.
		kShadedNonTextured = 1<<(3),//!< Display shaded non-textured
