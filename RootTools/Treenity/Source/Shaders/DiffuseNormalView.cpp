...
DiffuseNormalShaderView::DiffuseNormalShaderView(QWidget* p_parent)
...
void DiffuseNormalShaderView::SetEngineInterface(EngineInterface* p_engineInterface)
{
...
void DiffuseNormalShaderView::Display()
{
...
void DiffuseNormalShaderView::TextureChanged( Render::TextureInterface* p_texture, Render::TextureSemantic::TextureSemantic p_sem )
{
