...
#include "../Include/Components/ScriptView.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ScriptView_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 24, 12)
    ...
    "ScriptView\0NameChanged\0\0BrowseScript\0"
};
...
void ScriptView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ScriptView *_t = static_cast<ScriptView *>(_o);
        switch (_id) {
        case 0: _t->NameChanged(); break;
        case 1: _t->BrowseScript(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ScriptView::staticMetaObject = {
    { &AbstractComponentView::staticMetaObject, qt_meta_stringdata_ScriptView.data,
      qt_meta_data_ScriptView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ScriptView.stringdata))
        return static_cast<void*>(const_cast< ScriptView*>(this));
