...
namespace RootForce
{
	...
	private:
		bool UpdateUpperBodyAnimation(Renderable* p_renderable, Animation* p_animation, float p_ticksPerSecond, float p_animationSpeed );
		bool UpdateLowerBodyAnimation(Renderable* p_renderable, Animation* p_animation, float p_ticksPerSecond, float p_animationSpeed );
