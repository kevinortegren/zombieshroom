...
namespace Render
{
	...
	class AnimationInterface
	{
		public:
			...
			virtual void PushBoneInfo(BoneInfo p_boneInfo) = 0;
		...
		public:
			...
			void PushBoneInfo(BoneInfo p_boneInfo);
		...
		std::vector<Render::BoneInfo> m_boneInfo;
		std::vector<Render::VertexBoneData> m_boneData;
