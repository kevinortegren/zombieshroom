...
namespace Render
{
	...
	{
	public:
		virtual void BufferData(size_t p_elementCount, size_t p_elementSize, void* p_data, GLuint p_usage) = 0;
	...
	public:
		...
		void BufferData(size_t p_elementCount, size_t p_elementSize, void* p_data, GLuint p_usage);
