...
int main()
{
	...
	float pos[3] = {0,15,0};
	float rot[3] = {0,0,0};
	float posdyn[3] = {0,15,0};
	float posdyn2[3] = {0,12,0};
	float rotdyn[3] = {0,0,0};
	float SPEED[3] = {0,20,0};
	...
	int kanin = m_physics->AddDynamicObjectToWorld(NUM_TRIANGLES, &gIndices[0][0], 3*sizeof(int), NUM_VERTICES, &gVertices[0], sizeof(float)*3, posdyn2, rotdyn, 5.0f);
