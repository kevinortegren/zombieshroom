...
function XplodingMushroomPlanted.OnLoad()
	...
	ResourceManager.LoadSound("Abilities/Mine/mineland1-1.wav");
...
function XplodingMushroomPlanted.OnCreate (userId, actionId)
	...
	if Global.IsClient then
		...
		Static.PlaySound("Abilities/Mine/mineland1-1.wav", 1.0, startPos, 10.0, 100.0, bit32.bor(SoundMode.SOUND_LOOP_OFF, SoundMode.SOUND_3D, SoundMode.SOUND_3D_LINEARSQUAREROLLOFF));
	end
end
