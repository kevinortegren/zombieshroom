...
function FireBallExplosion.OnLoad()
	...
	ResourceManager.LoadSound("Abilities/Fireball/fireballfire2-4.wav", bit32.bor(SoundMode.SOUND_LOOP_OFF, SoundMode.SOUND_3D, SoundMode.SOUND_3D_LINEARSQUAREROLLOFF));
end
