...
function ExplodingShroom.OnLoad()
	...
	ResourceManager.LoadSound("Abilities/Mine/minethrow1-1.wav", bit32.bor(SoundMode.SOUND_LOOP_OFF, SoundMode.SOUND_3D, SoundMode.SOUND_3D_LINEARSQUAREROLLOFF));
...
function ExplodingShroom.OnCreate (userId, actionId)
	...
	if Global.IsClient then
		...
		Static.Play3DSound("Abilities/Mine/minethrow1-1.wav", 1.0, startPos, 10.0, 100.0);
	end
end
