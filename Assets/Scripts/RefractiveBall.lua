...
function RefractiveBall.OnLoad()
	...
	ResourceManager.LoadSound("Abilities/chargeloop1-1.wav", bit32.bor(SoundMode.SOUND_LOOP_NORMAL, SoundMode.SOUND_3D, SoundMode.SOUND_3D_LINEARSQUAREROLLOFF));
...
function RefractiveBall.OnCreate (userId, actionId)
	...
	if Global.IsClient then
		...
		soundable:SetSound("Abilities/chargeloop1-1.wav", bit32.bor(SoundMode.SOUND_LOOP_NORMAL, SoundMode.SOUND_3D, SoundMode.SOUND_3D_LINEARSQUAREROLLOFF));
