...
function PowerRay.OnLoad()
	ResourceManager.LoadSound("CC-BY3.0/qubodupElectricityDamage01.wav", 0x00200011);
end
...
function PowerRay.OnCreate (userId, actionId)
	...
	--Setting stuff
	soundable:SetSound("CC-BY3.0/qubodupElectricityDamage01.wav", 0x00200011);
	soundable:SetRange(0.0, 20.0);
